...
OutputDir=.\x64\Release\installer
OutputBaseFilename=OvGME_setup_x64
SetupIconFile=.\ovgme\res\icon.ico
Compression=lzma
...
Source: ".\ovgme\help\fr\ovgme.chm"; DestDir: "{app}"; Flags: ignoreversion
Source: ".\CHANGELOG.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: ".\ovgme\res\icon.ico"; DestDir: "{app}"; Flags: ignoreversion
